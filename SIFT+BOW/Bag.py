...
class Bag_of_words:
    ...
    def trainModel(self):
        ...
        self.images, self.trainImageCount, self.names = self.file_helper.getFiles(
            self.train_path)
        ...
        for word, imlist in self.images.items():
            ...
            label_count += 1
        # print("label list:",len(self.train_labels))
    ...
    def testModel(self):
        ...
        self.testImage=self.test_path

        predictions = []
        im = cv2.imread(self.testImage, 0)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_path', action="store",
                        dest="train_path", required=True)
    # parser.add_argument('--test_path', action="store",
                        # dest="test_path", required=True)
